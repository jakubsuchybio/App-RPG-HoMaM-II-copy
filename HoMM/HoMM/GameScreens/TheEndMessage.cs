...
{
    public class TheEndMessage : GameScreen
    {
        ...
        public TheEndMessage(Game game, ScreenManager manager)
            : base(game)
        {
        ...
        protected override void LoadContent()
        {
            ...
            //Vytvoreni pozadi
            background = new BackgroundComponent(GameRef, Content.Load<Texture2D>(@"Backgrounds\theendMessage"), DrawMode.Center);

            //Vytvoreni tlacitka pro potvrzeni vyberu
            LinkLabel Button = new LinkLabel(spriteFont);
            Button.Text = "Ukoncit a vratit se na hlavni menu.";
